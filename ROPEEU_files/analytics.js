(function() {
    ...
    */
    ...
    var p = function(a, b) { for (var c in b) b.hasOwnProperty(c) && (a[c] = b[c]) },
        q = function(a) {
            for (var b in a)
    ...
    */
    ...
    var w = window,
        ...
        z = document,
        A = navigator,
        B = function(a, b) { z.addEventListener ? z.addEventListener(a, b, !1) : z.attachEvent && z.attachEvent("on" + a, b) };
    var C = /:[0-9]+$/,
        F = function(a, b) { b && (b = String(b).toLowerCase()); if ("protocol" === b || "port" === b) a.protocol = D(a.protocol) || D(w.location.protocol); "port" === b ? a.port = String(Number(a.hostname ? a.port : w.location.port) || ("http" === a.protocol ? 80 : "https" === a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname || w.location.hostname).replace(C, "").toLowerCase()); return E(a, b) },
        E = function(a, b, c) {
            var d = D(a.protocol);
                ...
                if (g = !c || h.forms) a: {
                    ...
                    if (g && (m || k !== z.location.hostname))
                        for (var l = 0; l < g.length; l++)
                            if (g[l] instanceof RegExp) { if (g[l].test(k)) { g = !0; break a } } else if (0 <= k.indexOf(g[l]) || m && 0 <= g[l].indexOf(k)) { g = !0; break a }
                    g = !1
                }
    ...
    function ia(a) {
        return function(b) {
            ...
            a: {
                var e = d.split("&");
                for (var f = 0; f < e.length; f++) { var h = e[f].split("="); if ("_gl" === decodeURIComponent(h[0]).replace(/\+/g, " ")) { e = h.slice(1).join("="); break a } }
                e = void 0
            }
            b.query = T(e || "") || {};
            e = F(c, "fragment");
    ...
    function ja(a, b, c) {
        ...
        if (y && y.replaceState) { var e = Q("_gl"); if (e.test(b) || e.test(c)) a = F(a, "path"), b = d(b, "?"), c = d(c, "#"), y.replaceState({}, void 0, "" + a + b + c) }
    }
    var T = function(a) {
        try {
            a: {
                if (a) {
                    ...
                    if (d && "1" === d[1]) {
                        ...
                        b: {
                            for (d = 0; 3 > d; ++d)
                                if (e === R(f, d)) { var h = !0; break b }
                            h = !1
                        }
                        if (h) { var g = f; break a }
                        v(7)
                    }
                }
                g = void 0
    ...
    function ca(a) {
        try {
            ...
            if (c) { var d = c.protocol; "http:" !== d && "https:" !== d || W(c, c.hostname) }
        }
        catch (e) {}
    }
    ...
    n("google_tag_data.glBridge.decorate", function(a, b, c) { a = S(a); return Z("_gl", a, b, !!c) });
...
(function() {
    ...
    */
    ...
    var ab = function(a, b, c, d) {
        ...
        gf = { hitPayload: 88, location: 89, referrer: 90, title: 91, buildHitTask: 93, sendHitTask: 94, displayFeaturesTask: 95, customTask: 97, cookieName: 98, cookieDomain: 99, cookiePath: 100, cookieExpires: 101, cookieUpdate: 102, cookieFlags: 103, storage: 104, _x_19: 105, transportUrl: 106, allowAdFeatures: 107, sampleRate: 108 };
